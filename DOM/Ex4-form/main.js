const validate_name = function(){
    ...
    {
        valid_text.innerText = "Add your name";
        return false;
    }
    else
        return true;
...
const validate_salary = function(){
    ...
    {
        valid_text.innerText = "Invalid Salary must be 10k-16k flat";
        return false;
    }
    else
        return true;
...
const validate_birthday = function(){
    ...
    {
        valid_text.innerText = "Add Birthday";
        return false;
    }
    else
        return true;
...
const validate_phone = function(){
    ...
    {
        valid_text.innerText = "wrong Phone number";
        return false;
    }
    else
        return true;
